...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: '/upload',
        element: <Suspense fallback={fallback}><Upload /></Suspense>,
      },
      {
        path: '/channels',
        element: <Suspense fallback={fallback}><Channels /></Suspense>,
      },
      {
        path: '/:videoId',
        element: <Suspense fallback={fallback}><Video /></Suspense>,
      },
      {
        path: '/channel/:channelId',
        element: <Suspense fallback={fallback}><Channel /></Suspense>,
      },
      {
        path: '/edit/:videoId',
        element: <Suspense fallback={fallback}><Edit /></Suspense>,
      },
      {
        path: '/privacy',
        element: <Suspense fallback={fallback}><PrivacyPolicy /></Suspense>,
      },
      {
        path: '/terms',
        element: <Suspense fallback={fallback}><TermsOfService /></Suspense>,
      },
      {
        path: '/contact',
        element: <Suspense fallback={fallback}><Contact /></Suspense>,
      },
    ],
  },
]);
